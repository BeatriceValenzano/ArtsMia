...
//  Voglio prendere un id e calcolare la dimensione della componente connessa che contiene quel nodo
...
//    	RICORDA DI GESTIRE
    	...
    	if(model.isIdInGraph(inputNum)) {
    		Integer sizeConnessa = this.model.componenteConnessa(inputNum);
